...
export default function ClaimPoapPage({ params }: { params: { qr: string } }) {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center p-8 max-w-md w-full">
          ...
          <p className="text-lg font-medium text-gray-700">Loading POAP details...</p>
        </div>
      </div>
    );
  }
            ...
            <div className="px-4 py-5 sm:p-6">
              <div className="flex flex-col items-center">
                ...
                <p className="text-gray-500 text-center mb-6">
                  {poapDetails.description || 'Claim this special POAP for your collection!'}
                </p>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-yellow-700">
                  Invalid QR code or POAP not found. Please scan a valid QR code.
                </p>
              </div>
            </div>
          </div>
